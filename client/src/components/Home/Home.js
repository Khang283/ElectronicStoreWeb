  ...
  return (
    <Box className="bg-light">
        ...
        <Row xs={2} md={8} sm={4}>
          <div className="cate-item">
            <Link to="/phone" className="cate-item-name">
              <div className="cate-img">
                <img src="/cell-phone.png" alt="/phone-logo.png"></img>
              </div>
              <div>Điện Thoại</div>
            </Link>
          </div>
          ...
          <div className="cate-item">
            <Link to="/laptop" className="cate-item-name">
              <div className="cate-img">
                <img src="/laptop(1).png" alt="Laptop"></img>
              </div>
              <div>Laptop</div>
            </Link>
          </div>
          ...
          <div className="cate-item">
            <Link to="/tablet" className="cate-item-name">
              <div className="cate-img">
                <img src="/tablet(1).png" alt="Tablet"></img>
              </div>
          ...
          <div className="cate-item">
            <Link to="/accessories" className="cate-item-name">
              <div className="cate-img">
                <img src="/usb.png" alt="Accessories "></img>
              </div>
              <div>Phụ Kiện</div>
            </Link>
          </div>
      ...
      <div className="container div-list">
                      ...
                      >
                        <Square m="auto" _hover={{ transform: "scale(1.1)" }}>
                          <Image
                            ...
                            boxSize="160px"
                            fallbackSrc="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeyOIU0kkPJe1f_kwLcA6P-b7UIn3l3s7juw&usqp=CAU"
                          />
                        </Square>
                        <Box p="2" mt="4">
                          <Text
        ...
        <div className="home-btn">
          <Button variant="outline-secondary" size="sm" href="phone">
            Xem tất cả{" "}
          </Button>{" "}
        </div>
      </div>
      ...
      <div className="container div-list">
        ...
        <div className="home-btn">
          <Button variant="outline-secondary" size="sm" href="laptop">
            Xem tất cả{" "}
          </Button>{" "}
        </div>
      </div>
      ...
      <div className="container div-list">
                          ...
                          <Box mt="2.5">
                            ...
                            <Flex>
                              ...
                              <Square>
                                <Box className="product-rating">
                                  {Array.from({ length: 5 }).map((_, idx) =>
                                    idx < parseInt(product.productRating) ? (
                                      <StarIcon color="teal.500" />
                                    ) : (
                                      <StarIcon />
                                    ),
        ...
        <div className="home-btn">
          <Button variant="outline-secondary" size="sm" href="tablet">
            Xem tất cả{" "}
          </Button>{" "}
        </div>
      </div>
